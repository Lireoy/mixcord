...
public class Constants {
    ...
    public static final String WEBSITE = "https://streamcord.io/mixer/";
    public static final String DISCORD = "https://discord.gg/PXU46xR";
    public static final String UPVOTE = "https://discordbots.org/bot/upvotehere";
    public static final String DONATE = "https://patreon.com/devakira";

    // MIXER
    public static final String MIXER_COM = "https://mixer.com/";
